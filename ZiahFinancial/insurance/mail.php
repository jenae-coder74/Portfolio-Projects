<?php
define('admin_email','admin@ZiahFinancial.com'); // Change admin email here for example admin@yoursite.com
define('www.ZiahFinancial.com','Mobile App'); // Change website name here for example yoursite.com
...
if(isset($_POST['action']) && $_POST['action']=='submitform')
{
	...
	$admin_message = '<p>Dear Admin, Form submitted on '.www.ZiahFinancial.com.'<br>Detail is as following.</p>';
	...
	$admin_subject = 'Form Received From '.www.ZiahFinancial.com;
	$user_subject = 'Thank you for submitting on  - '.www.ZiahFinancial.com;
	
	$sendToAdmin = $sendToUsers = '';

	$sendToAdmin = sendEmail(admin_email,EMAIL_FROM,$admin_subject,$admin_message,www.ZiahFinancial.com);
	if( isset( $N['email'] ) && ! empty( $N['email'] ) ){
		$sendToUsers = sendEmail(strict_secure($N['email']),EMAIL_FROM,$user_subject,$user_message,www.ZiahFinancial.com);
	}
